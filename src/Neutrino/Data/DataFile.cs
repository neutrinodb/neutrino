...
//        public static readonly byte FileVersion = 1;
//        public static readonly int HeaderSize = (sizeof(Int64) * 3) + sizeof(Int32) * 2 + sizeof(byte);
...
//            int read;
//            using (var fs = FileStreamEx.OpenWithoutLock(path)) {
//                read = await fs.ReadAsync(header, 0, HeaderSize);
//            }
//            if (read != HeaderSize) {
//                await Try.It(() => File.Delete(id), 5, 100);
